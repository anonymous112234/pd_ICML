...
# Testing Hyperparameter search
def new_CIFAR_LRSchedule_hps_individual_without_regularization():
...
# Testing Hyperparameter search
def new_CIFAR_LRSchedule_hps_individual_with_regularization():
