...
from NN_models import new_hps_NN_individual_without_regularization
...
for h in range(len(SEED)):
	...
	with open('../BasicGridSearch_CIFAR_Benchmark_without_regularization.csv', 'a', newline = '') as file:
