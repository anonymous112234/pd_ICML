...
# python3 -m KT_RandomSearch_CIFAR100_Benchmark_without_regularization
...
for seed in SEED:  
	...
	def graph_history(history):
		...
		filename = "KerasTuner_CIFAR100_progress_without_reg_line.pdf"
		save_image(filename)
		...
		filename = "KerasTuner_CIFAR100_progress_without_reg__with_points.pdf"
		save_image(filename)
	...
	model_num = "1_without_reg"

	# writing data to excel file
	data = [[test_loss, train_loss, model_num, max_trials, time_lapsed, seed]]

	with open('../KT_RandomSearch_CIFAR100_Benchmark_without_regularization.csv', 'a', newline = '') as file:
