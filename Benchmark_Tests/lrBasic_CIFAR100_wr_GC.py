...
from nn_models_CIFAR100 import new_CIFAR_LRSchedule_hps_individual_with_regularization
...
for h in range(len(SEED)):
	...
	with open('../BasicGridSearch_CIFAR100_LRSchedule_Benchmark_with_regularization.csv', 'a', newline = '') as file:
