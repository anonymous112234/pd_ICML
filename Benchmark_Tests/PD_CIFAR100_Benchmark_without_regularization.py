...
# cd Benchmark_Tests
# python3 -m PD_CIFAR100_Benchmark_without_regularization
...
from nn_models_CIFAR100 import new_CIFAR100_individual_without_regularization
...
def create_Parameters_NN_object(pop_size, randomization, CV_selection, rr):
	...
	object = individual_to_params(pop_size, lambda: new_CIFAR100_individual_without_regularization(), NN_randomizer_manual_loss, NN_optimizer_manual_loss, observer, randomization=randomization, CV_selection=CV_selection, rr=rr, history=history)
