...
from NN_models import new_hps_NN_LRSchedule_individual_with_regularization
...
for h in range(len(SEED)):
	...
	population, reg_list, model_num = new_hps_NN_LRSchedule_individual_with_regularization()
	...
	with open('../BasicGridSearch_CIFAR_LRSchedule_Benchmark_with_regularization.csv', 'a', newline = '') as file:
