...
from NN_models import new_pd_NN_individual_without_regularization, new_hps_NN_individual
...
if __name__ == "__main__":
	...
	for i in range(len(SEED)):
		...
		with open('../pd_CIFAR_benchmark_without_regularization.csv', 'a', newline = '') as file:
