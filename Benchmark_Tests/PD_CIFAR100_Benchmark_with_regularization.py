...
# cd Benchmark_Tests
# python3 -m PD_CIFAR100_Benchmark_with_regularization
...
from nn_models_CIFAR100 import new_CIFAR100_individual_with_regularization
...
def create_Parameters_NN_object(pop_size, randomization, CV_selection, rr):
	...
	object = individual_to_params(pop_size, lambda: new_CIFAR100_individual_with_regularization(), NN_randomizer_manual_loss, NN_optimizer_manual_loss, observer, randomization=randomization, CV_selection=CV_selection, rr=rr, history=history)
...
if __name__ == "__main__":
	...
	for i in range(len(SEED)):
		...
		with open('../pd_CIFAR100_benchmark_with_regularization.csv', 'a', newline = '') as file:
