...
from NN_models import new_hps_NN_LRSchedule_individual_without_regularization
...
for h in range(len(SEED)):
	...
	population, reg_list, model_num = new_hps_NN_LRSchedule_individual_without_regularization()
	...
	with open('../BasicGridSearch_CIFAR_LRSchedule_Benchmark_without_regularization.csv', 'a', newline = '') as file:
