...
from NN_models_FMNIST import new_hps_NN_individual_FMNIST_with_regularization
...
for h in range(len(SEED)):
	...
	population, reg_list, model_num = new_hps_NN_individual_FMNIST_with_regularization()
	...
	with open('../BasicGridSearch_FMNIST_Benchmark_with_regularization.csv', 'a', newline = '') as file:
