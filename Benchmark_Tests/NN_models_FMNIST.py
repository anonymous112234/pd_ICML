...
# For passing in learning rate schedules to optimizer
def new_hps_NN_individual_FMNIST_LRSchedule_without_regularization():
	...
	for r in range(len(regularization_amount)):
		for l in range(len(learning_rate)):
			...
			lr_schedule = tf.keras.optimizers.schedules.ExponentialDecay(
			    initial_learning_rate=learning_rate[l],
			    decay_steps=10000,
			    decay_rate=0.9)
...
# Testing Hyperparameter search
def new_hps_NN_individual_FMNIST_LRSchedule_with_regularization():
