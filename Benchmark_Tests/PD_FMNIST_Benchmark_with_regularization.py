...
from NN_models_FMNIST import new_pd_NN_individual_FMNIST_with_regularization, new_hps_NN_individual_FMNIST
...
def create_Parameters_NN_object(pop_size, randomization, CV_selection, rr):
	...
	object = individual_to_params(pop_size, new_pd_NN_individual_FMNIST_with_regularization, NN_randomizer_manual_loss, NN_optimizer_manual_loss, observer, randomization=randomization, CV_selection=CV_selection, rr=rr, history=history)
...
if __name__ == "__main__":
	...
	for i in range(len(SEED)):
		...
		with open('../pd_FMNIST_benchmark_with_regularization.csv', 'a', newline = '') as file:
