...
from nn_models_CIFAR100 import new_CIFAR_LRSchedule_hps_individual_without_regularization
...
# cd Benchmark_Tests
# python3 -m BasicGridSearch_CIFAR100_Benchmark_without_regularization
...
for h in range(len(SEED)):
	...
	population, reg_list, model_num = new_CIFAR_LRSchedule_hps_individual_without_regularization()
	...
	with open('../BasicGridSearch_CIFAR100_LRSchedule_Benchmark_without_regularization.csv', 'a', newline = '') as file:
