...
from NN_models_FMNIST import new_pd_NN_individual_FMNIST_Ablation_Regularization, new_hps_NN_individual_FMNIST
...
def create_Parameters_NN_object(pop_size, randomization, CV_selection, rr):
	...
	object = individual_to_params(pop_size, new_pd_NN_individual_FMNIST_Ablation_Regularization, NN_randomizer_manual_loss, NN_optimizer_manual_loss, observer, randomization=randomization, CV_selection=CV_selection, rr=rr, history=history)
...
FM_train_images, FM_test_images = FM_train_images[0:10000] / 255.0, FM_test_images[0:10000] / 255.0 # for ablation
...
if __name__ == "__main__":
	...
	for i in range(len(SEED)):
		...
		with open('../ablation_noReg_noCV_FMNIST.csv', 'a', newline = '') as file:
